...
var makeMarkers = function(data) { return _.map(data, function(item){ return L.marker([item.Lat, item.Lng]);});};


// Now we need a function that takes this collection of markers and puts them on the map
var plotMarkers = function(markers) { return _.map(markers, function(item){return item.addTo(map);});};
